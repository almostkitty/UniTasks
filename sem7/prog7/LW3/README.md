...
## Часть 1: Запросы и ответы (Requests and Responses)
...
## Часть 2: Модели и административный сайт (Models and the Admin Site)
...
## Часть 3: Представления и шаблоны (Views and Templates)
...
## Часть 4: Формы и обобщенные представления (Forms and Generic Views)
...
- Добавлена защита от CSRF атак через {% csrf_token %}
...
## Часть 6: Статические файлы (Static Files)
...
*(CSS стили видны на скриншотах страниц приложения)*

## Часть 7: Настройка административного сайта (Customizing the Admin Site)
